...
exports.getAllStores = async (req, res) => {
  try {
    ...
    baseResponse(res, true, 200, "Stores retrieved", stores);
  } catch (error) {
...
exports.createStore = async (req, res) => {
  if (!req.body.name || !req.body.address) {
    return baseResponse(res, false, 400, "Store name and address are required");
  }
  try {
...
exports.updateStore = async (req, res) => {
  ...
  if (!id || !name || !address) {
    return baseResponse(res, false, 400, "Store ID, name, and address are required");
  }
  try {
